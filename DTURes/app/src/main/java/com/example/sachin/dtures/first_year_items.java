...
public class first_year_items extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Notesref=FirebaseDatabase.getInstance().getReference().child("users").child("FirstYear").child("Notes").child(itemsubject).child("GroupA");
        PaperRef=FirebaseDatabase.getInstance().getReference().child("users").child("FirstYear").child("Paper").child(itemsubject).child("GroupA");
        Practicalref=FirebaseDatabase.getInstance().getReference().child("users").child("FirstYear").child("Practical").child(itemsubject).child("GroupA");
    ...
    protected void onStart() {
        ...
        if (itemtype.equals("Books")) {
            ...
            bookrecyclerViewitems.setAdapter(booksBookViewholderFirebaseRecyclerAdapter);
             ...
             Toast.makeText(first_year_items.this,"in notes",Toast.LENGTH_SHORT).show();
            FirebaseRecyclerAdapter<Books, BookViewholder> booksBookViewholderFirebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Books, BookViewholder>(
                    Books.class,
                    R.layout.booklayout,
                    BookViewholder.class,
    ...
    void loadGroupBitems(){
        if (itemtype.equals("Books")) {
            ...
            Notesref=FirebaseDatabase.getInstance().getReference().child("users").child("FirstYear").child("Notes").child(itemsubject).child("GroupB");
            FirebaseRecyclerAdapter<Books, BookViewholder> booksBookViewholderFirebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Books, BookViewholder>(
                    Books.class,
                    R.layout.booklayout,
                    BookViewholder.class,
            ...
            Practicalref=FirebaseDatabase.getInstance().getReference().child("users").child("FirstYear").child("Practical").child(itemsubject).child("GroupB");
            FirebaseRecyclerAdapter<Books, BookViewholder> booksBookViewholderFirebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Books, BookViewholder>(
                    Books.class,
                    R.layout.booklayout,
                    BookViewholder.class,
            ...
            PaperRef=FirebaseDatabase.getInstance().getReference().child("users").child("FirstYear").child("Paper").child(itemsubject).child("GroupB");
            FirebaseRecyclerAdapter<Books, BookViewholder> booksBookViewholderFirebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Books, BookViewholder>(
                    Books.class,
                    R.layout.booklayout,
                    BookViewholder.class,
