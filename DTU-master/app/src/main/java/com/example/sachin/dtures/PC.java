...
public class PC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        subject.add(new abcd("papa",  R.drawable.computerblack));
        subject.add(new abcd("Ma",  R.drawable.computerblack));
        subject.add(new abcd("Beta",  R.drawable.computerblack));
        subject.add(new abcd("Beti",  R.drawable.computerblack));
        subject.add(new abcd("nani",  R.drawable.computerblack));
        subject.add(new abcd("nana",  R.drawable.computerblack));
